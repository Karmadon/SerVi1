...
// reph_position
		...
		public static function matra_position($u, $side)
		{
			...
			return $side;
				...
				public static function MATRA_POS_LEFT($u) { return self::POS_PRE_M; }    // POS_AFTER_MAIN,
		...
		public static function IS_DEVA($u) { return self::IN_HALF_BLOCK($u, 0x0900); }    // POS_AFTER_SUB,

		public static function IN_HALF_BLOCK($u, $Base) { return (($u & ~0x7F) == $Base); }    // POS_BEFORE_POST,

		public static function IS_BENG($u) { return self::IN_HALF_BLOCK($u, 0x0980); }    // POS_AFTER_POST

// reph_mode

		public static function IS_GURU($u) { return self::IN_HALF_BLOCK($u, 0x0A00); }        /* Reph formed out of initial Ra,H sequence. */

		public static function IS_GUJR($u) { return self::IN_HALF_BLOCK($u, 0x0A80); }        /* Reph formed out of initial Ra,H,ZWJ sequence. */

		public static function IS_ORYA($u) { return self::IN_HALF_BLOCK($u, 0x0B00); }    /* Encoded Repha character, no reordering needed. */

		public static function IS_TAML($u) { return self::IN_HALF_BLOCK($u, 0x0B80); }    /* Encoded Repha character, needs reordering. */
