...
//============================================================+
	...
	class PDFBarcode
	{
		 ...
		 * presort identification that is currently printed in human readable form on the optional endorsement line
		 * (OEL) as well as for future USPS use. This shall be two digits, with the second digit in the range of 0-4.
		 * The allowable encoding ranges shall be 00-04, 10-14, 20-24, 30-34, 40-44, 50-54, 60-64, 70-74, 80-84, and
		 * 90-94.</li><li>The Service Type Identifier shall be assigned by USPS for any combination of services
		 * requested on the mailpiece. The allowable encoding range shall be 000-999. Each 3-digit value shall
		 * correspond to a particular mail class with a particular combination of service(s). Each service program,
		 * such as OneCode Confirm and OneCode ACS, shall provide the list of Service Type Identifier
