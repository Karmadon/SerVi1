...
*/
			...
			if ($shaper)
			{
				...
				{
					CASE 'bng2':
						if (isset($ScriptLang['beng'])) return array('beng', TRUE);
					CASE 'dev2':
						if (isset($ScriptLang['deva'])) return array('deva', TRUE);
					CASE 'gjr2':
						if (isset($ScriptLang['gujr'])) return array('gujr', TRUE);
					CASE 'gur2':
						if (isset($ScriptLang['guru'])) return array('guru', TRUE);
					CASE 'knd2':
						if (isset($ScriptLang['knda'])) return array('knda', TRUE);
					CASE 'mlm2':
						if (isset($ScriptLang['mlym'])) return array('mlym', TRUE);
					CASE 'ory2':
						if (isset($ScriptLang['orya'])) return array('orya', TRUE);
					CASE 'tml2':
						if (isset($ScriptLang['taml'])) return array('taml', TRUE);
					CASE 'tel2':
						if (isset($ScriptLang['telu'])) return array('telu', TRUE);
					CASE 'mym2':
						if (isset($ScriptLang['mymr'])) return array('mymr', TRUE);
				}
			}
